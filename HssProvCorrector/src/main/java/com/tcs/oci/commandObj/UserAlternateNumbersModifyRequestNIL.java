...
//    
//    public UserAlternateNumbersModifyRequestNIL(BaseImpl implObj, Map<String, String> paramList, List<AlternateNumberEntry> alternateNumberList, String xmlName) throws OciException {
...
//                    if (tempIndex.size()>0)
//                    {
//                    entryNum = tempIndex.get(counter);
//                    counter++;
//                    }
...
public class UserAlternateNumbersModifyRequestNIL extends BaseOci {
    ...
    public UserAlternateNumbersModifyRequestNIL(BaseImpl implObj, Map<String, String> paramList, List<AlternateNumberEntry> alternateNumberList, String xmlName) throws OciException, IOException {
        super(implObj, "UserAlternateNumbersModifyRequestNIL", xmlName);
        try {
            Document doc = this.getRequestDoc();
            doc = XmlDocHandlerUpdated.setTagInXml(doc, "sessionId", paramList.get("timeStamp"), 0);
